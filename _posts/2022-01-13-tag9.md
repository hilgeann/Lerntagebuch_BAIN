...
Beim Ausbauen der Query werden einem ausserdem aufgrund der Wahl einer bestimmten Property automatisch dann mögliche Objekte angezeigt bzw. auch bei der Eingabe der Property werden Vorschläge zur Vervollständigung angezeigt. 
...
Damit dann aber trotzdem alle Personen angezeigt werden, auch wenn für diese kein Geburtsort oder -datum hinterlegt ist, werden diese beiden Variablen als OPTIONAL deklariert.
...
Was dann nicht funktioniert hat, ist die Abfrage zu erweitern, indem die Personen nach Property «Autor» und Objekt «Roman» abgefragt werden.
